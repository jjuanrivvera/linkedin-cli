...
Update linkedin to the latest GitHub release

### Synopsis

Download the latest linkedin release, verify it against checksums.txt, and replace
the running binary in place. Use 'linkedin update check' to see what's available without
installing.

```
linkedin update [flags]
```
...
* [linkedin update check](linkedin_update_check.md)	 - Check for a newer release without installing it
