...
Look up LinkedIn companies

### Synopsis

Fetch a LinkedIn organization by its universalName (the slug in a company URL).
...
* [linkedin company get](linkedin_company_get.md)	 - Fetch a company by its universalName (slug)
