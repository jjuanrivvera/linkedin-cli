...
* [linkedin mcp vscode disable](linkedin_mcp_vscode_disable.md)	 - Remove server from VSCode config
* [linkedin mcp vscode enable](linkedin_mcp_vscode_enable.md)	 - Add server to VSCode config
* [linkedin mcp vscode list](linkedin_mcp_vscode_list.md)	 - Show VSCode MCP servers
