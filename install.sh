#!/bin/sh
# linkedin installer for macOS and Linux.
#
...
#   LINKEDIN_VERSION=v1.2.3        pin a version (default: the latest release)
...
REPO="jjuanrivvera/linkedin-cli"
BINARY="linkedin"
...
if [ -z "$VERSION" ]; then
  ...
  [ -n "$VERSION" ] || die "could not determine the latest release; set LINKEDIN_VERSION"
fi
