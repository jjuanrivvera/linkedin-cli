...
func init() {
	metaRegistrars = append(metaRegistrars, func(_ *deps) *cobra.Command {
		...
		cmd := &cobra.Command{
			...
			Example: `  linkedin version
  linkedin version --json
  linkedin version --check`,
			Args: cobra.NoArgs,
...
var latestReleaseURL = "https://api.github.com/repos/jjuanrivvera/linkedin-cli/releases/latest"
